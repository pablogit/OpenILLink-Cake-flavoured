...
// ***************************************************************************
	...
	$this->set('title_for_layout', __('Création d\'un nouveau lien sortant'));

	echo '<div class="manage_title">', __("Gestion des liens sortants : Création d'une nouvelle fiche"), '</div>';
	...
	echo '<div class="manage_footer">', $this->Form->button(__('Enregistrer le nouveau lien'), array('class' => 'btn')), $this->Html->link(__('Annuler'), array('action' => 'index'), array('class' => 'btn')), '</div>';
	echo $this->Form->end();
?>